  ...
  return (
    <Layout>
      ...
      <div className="text-indigo-700 bg-indigo-800 pattern-grid-lg ">
        <div className="relative flex flex-col items-center justify-start min-h-screen pt-12 md:pt-24 from-indigo-700 via-indigo-800 to-transparent bg-gradient-to-b ">
