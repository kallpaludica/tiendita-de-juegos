    ...
    <div className="flex sm:flex-col">
      ...
      <div className="relative flex flex-col w-full px-0 pb-0 font-sans text-left bg-white ">
        <div className="flex-grow" style={{ minHeight: "80px" }}>
          <Link
            to={`/tienda-de-juegos/${kebabCase(card.slug)}/`}
            className="flex-grow inline-block px-2 pt-4 pb-2 pr-10 font-sans text-lg font-bold leading-6 hover:text-green-600"
          >
            {card.title}
          </Link>
          {card.GameAges && (
            <div className="hidden w-full px-2 pt-1 text-center game-ages md:px-0 ">
              <div className="flex justify-start pb-1 font-sans text-lg font-bold text-left text-gray-700 md:px-2 ">
          ...
          {card.GameDuration && (
            <div className="hidden w-full px-2 pt-1 text-center game-duration md:px-0">
              <div className="flex justify-center pb-1 font-sans text-lg font-bold text-center text-gray-700 md:px-2 ">
                <div className="flex flex-1 text-base opacity-100">
          ...
          {card.GamePlayers && (
            <div className="hidden w-full pt-1 text-center game-players">
              <div className="flex justify-center pb-1 font-sans text-lg font-bold text-center text-gray-700 ">
          ...
          {card.stock && (
            <div
              className="relative top-0 right-0 flex items-center justify-end p-2 px-2 m-1 my-2 font-sans text-sm font-bold text-left text-blue-600 transition-all duration-500 md:absolute md:text-base hover:text-white hover:bg-blue-500 "
        ...
        >
          <div className="flex items-center justify-between p-2 px-2 font-sans text-lg font-bold text-left text-green-600 transition-all duration-500 bg-white hover:text-green-500 hover:bg-green-100">
            <span>Ver mas</span>
