...
const HeroWave = (props) => (
  <>
    ...
    >
      {props.heading && (
        <div
          className={`${props.center ? "items-center" : "items-start"}
        ...
        >
          ...
          {props.back && (
            <div className="flex items-start justify-start py-3">
              <Link
                to={props.backUrl}
                className="p-3 font-sans text-base font-bold text-white border-b border-white hover:bg-white hover:text-indigo-500"
              >
                {props.back}
              </Link>
            </div>
