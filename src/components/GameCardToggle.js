  ...
  return (
    <>
      <animated.div
        ...
        style={fade}
      >
        <h2 className="w-full pb-1 mb-3 font-sans text-lg font-bold text-left text-orange-600 border-b border-orange-600">
        ...
        <Link
          ...
          className="absolute bottom-0 left-0 right-0 flex items-center justify-between p-2 px-3 font-sans text-sm font-bold text-left text-white transition-all duration-500 bg-orange-600 hover:text-white hover:bg-orange-500"
        >
          Consultar
